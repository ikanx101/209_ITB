...
rm(list=ls())
setwd("~/209_ITB/Thesis/Penelitian Mandiri III/Versi Kelas/Week I")
```
...
__Optimisasi Pembelian Raw Material dan Supplier Selection Minuman Serbuk Menggunakan Metode XXX: Studi Kasus PT. NFI Indonesia.__
...
- Penelitian Mandiri II: _Data collection_ dan dokumentasi _production system_.
- Penelitian Mandiri III: Model optimisasi yang telah disempurnakan.
