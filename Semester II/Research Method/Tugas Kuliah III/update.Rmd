...
setwd("~/209_ITB/Semester II/Research Method/Tugas Kuliah III")
...
data = read_excel("~/209_ITB/Semester II/Research Method/Tugas Kuliah I/20201207 Product list.xlsx") %>% janitor::clean_names() %>% filter(cost_benefit > 0)
data %>% 
...
$$\begin{matrix}
\text{cari } Xi \in [0,1] \text{ sehingga } \max{(X_i  Pr_i)} , i \in \{ 1,2,3,..,n\} \\
\text{terhadap } \sum_{i = 1}^n X_i Bg_i \leq 200.000.000
\end{matrix}$$
