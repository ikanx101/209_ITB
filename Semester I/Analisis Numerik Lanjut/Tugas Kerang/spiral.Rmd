...
Misalkan saya memiliki titik $x \in \mathbb{R}^2$. Untuk melakukan rotasi sebesar $\theta$, kita bisa menggunakan suatu matrik $A_{2 \times 2}$ berisi fungsi-fungsi trigonometri. Berikut adalah caranya:
...
Kita uji coba dengan titik sembarang berikut ini:
