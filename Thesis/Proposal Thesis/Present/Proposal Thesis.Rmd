...
- Sebagai _business user_, tim PPIC membutuhkan _tools_ yang mudah digunakan dan mempercepat produktivitas dalam bekerja. 
    - Formatnya _single app_ tanpa _compiler_.
...
```{r out.width="100%",echo=FALSE,fig.retina=7,fig.align='center',fig.cap="Rencana Penyelesaian Masalah"}
nomnoml::nomnoml("#direction: right
                 [<start> start] -> [pembuatan model\noptimisasi|Berdasarkan alur produksi]
                 [pembuatan model\noptimisasi] -> [program|R codes|library(ompr)]
                 [program] -> [validasi|Menggunakan data pada rentang\nwaktu tertentu]
