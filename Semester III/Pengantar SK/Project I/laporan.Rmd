...
Berikut adalah ilustrasi dari peluruhan:

```{r,echo=FALSE,fig.cap = "Ilustrasi Peluruhan"}
rm(list=ls())
...
Berikut adalah ilustrasi dari pertumbuhan:

```{r,echo=FALSE,fig.cap = "Ilustrasi Pertumbuhan"}
rm(list=ls())
