...
Perbandingan Metode Eksak dan Metode Meta Heuristic Model optimisasi portofolio diskon produk _e-commerce_ dan membandingkan solusi metode eksak (_simplex_) dengan metode _meta heuristic_ (_ABC_ dan _SOA_).
