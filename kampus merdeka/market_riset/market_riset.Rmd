...
```{r out.width = "75%",echo=FALSE,fig.align = "center",fig.cap = "Ilustrasi Indepth Interview"}
...
```{r out.width = "75%",echo=FALSE,fig.align = "center",fig.cap = "Ilustrasi Qualitative Observation"}
