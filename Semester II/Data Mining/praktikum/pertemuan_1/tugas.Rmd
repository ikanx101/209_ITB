...
Sedangkan untuk data bertipe numerik, saya akan lakukan normalisasi dengan cara berikut:

$$\hat{x} = \frac{x - \bar{x}}{\sigma}$$

### Data _Blank_ atau `NA`

Khusus data yang memiliki nilai _blank_, baik pada tipe `numeric` dan `character`, saya akan lakukan _imputation_ dengan me-_replace_ data _blank_ tersebut dengan:

1. Median untuk data numerik.
1. Modus untuk data _character_.

## _Pre-Processing_

Pertama-tama lakukan terlebih dahulu _imputation_
