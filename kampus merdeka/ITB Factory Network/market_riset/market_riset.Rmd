...
## _Google Trend_ Omicron

## _Open Data_ Penyebab Kebakaran di Jakarta

Beberapa pemerintah daerah memiliki situs _open data_ yang bisa kita jadikan rujukan. Salah satunya adalah situs _open data_ Jakarta berikut ini: https://data.jakarta.go.id/

Saya akan mengambil `data frekuensi kebakaran, obyek terbakar, korban, dan taksiran kerugian di Prov. DKI Jakarta` yang di-_update_ terakhir pada `17 Juni 2021`.
