...
```{r,echo=FALSE,fig.cap = "Hasil Simulasi Program Euler"}
knitr::include_graphics("skrinsut_1.png")
```

Sekarang saya akan _run_ program ini sekali lagi menggunakan parameter yang ada di soal, yakni:
...
df %>% kable::knitr(caption = "Hasil Simulasi Program Euler Menggunakan Parameter Soal")
```
