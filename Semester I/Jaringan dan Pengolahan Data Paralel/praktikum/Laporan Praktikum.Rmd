...
Pada soal I ini saya menggunakan $n = 10^8$. Berikut adalah program _serial processing_ yang dibuat:
...
nilai = c(0.33333333333331167,0.33333333333331167,0.3333333333333456,0.3333333333333455,
	  0.3333333333333456,0.33333333333333925,0.33333333333331167,NA)
runtime = c(27.43908143043518,56.21210050582886,6.989081621170044,7.089271306991577,
	   7.081090211868286,7.525770664215088,254.07278299331665,NA)
```


## Soal II

Hitung nilai $\pi$ dengan menyelesaikan: $\int_0^1 4 \sqtr{1 - x^2}$ dengan $n = 10^8$.
