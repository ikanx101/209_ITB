...
setwd("~/S2 Sains Komputasi ITB/Kuliah/Semester I/Jaringan dan Pengolahan Data Paralel")
library(dplyr)
library(ggplot2)
...
`/etc/resolve.conf` memberi tahu kernel server nama mana yang harus ditanyakan ketika sebuah program meminta untuk _me-resolve_ alamat IP.
