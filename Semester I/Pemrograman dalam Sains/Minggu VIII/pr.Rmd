...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.retina = 10,fig.caption = "Gambar 15.1"}
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.retina = 10,fig.caption = "Gambar 15.2"}
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.retina = 10,fig.caption = "Gambar 15.3"}
