...
Secara bahasa, _interview_ berarti wawancara. Dalam riset kuantitatif, _interview_ yang dimaksud adalah _survey_ yakni mencari sejumlah banyak orang sebagai responden untuk diwawancarai dengan panduan kuesioner yang terstruktur. 
...
Namun, untuk lebih tepat kita dapat menggunakan _sample size calculator online_. Salah satunya adalah _calculator_ pada situs berikut ini^[https://www.calculator.net/sample-size-calculator.html] :
...
```{r out.width = "60%",echo=FALSE,fig.align = "center",fig.cap = "Tahapan Data Processing"}
...
nama = randomNames::randomNames(7,gender = "male",which.names = "first")
...
Walaupun terkesan biasa saja xxxxxx

> jangan lupa tambahin strategi perusahaan inhose vs non in house. satu lagi kasih au bahwa setiap minggu baru akan release materi minggu depannya. selesaikan discussion erlebih dahulu
