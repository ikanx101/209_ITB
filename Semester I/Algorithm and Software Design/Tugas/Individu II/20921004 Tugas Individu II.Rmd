...
header-includes:
- \usepackage{titling}
- \pretitle{\begin{center}\includegraphics[width=4in,height=4in]{Screenshot_20210911_102935.jpg}\LARGE\\}
...
_By using numerical integration, find the area under the following curve:_

```{r out.width="50%",echo=FALSE,warning=FALSE,message=FALSE,fig.align='center',fig.cap="Soal 2"}
knitr::include_graphics("Screenshot_20210911_140215.jpg")
```
...
```{r,echo=FALSE,warning=FALSE,message=FALSE,fig.align='center',fig.cap="Soal 2"}
rm(list=ls())
