...
Salah satu contoh _market research project_ yg erat kaitannya dengan _sales research_ adalah _retail audit_. _Retail audit_ berarti mengumpulkan data transaksi pembukuan toko _retail_ untuk kemudian dianalisa. Jadi berbeda dengan survey atau tipe riset yang mengumpulkan data _end-consumer_, _retail audit_ mengumpulkan data dari toko. Semua transaksi dari toko kepada konsumen seperti:

1. Waktu transaksi dan
1. SKU yang terjual.

Menjadi data yang krusial. Sebagai contoh, biasanya data yang didapatkan adalah sebagai berikut:
...
df %>% knitr::kable(align  = "c", caption = "Data Transaksi yang Dikumpulkan")
```
