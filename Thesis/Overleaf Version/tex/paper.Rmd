...
\begin{equation}
\sum_{k \in \mathcal N} a_{ijk} \geq 2 
\end{equation}
...
\begin{equation}
\sum_{k \in \mathcal N} (z_{0k} + \hat{x}_{1k} -  + z_{1k}) - D_1\leq maxcap  
\end{equation}

$\forall j \in \{2, 3, 4\}$,

\begin{equation}
    \sum_{k \in \mathcal N} (z_{(j-1)k} + \hat{x}_{(j-1)k}) - \sum_{i \in P_j} b_{ijk} g_{ik} + z_{jk} \leq maxcap  
\end{equation}

$\forall j \in \mathcal{M}$,

\begin{equation}
    \sum_{k \in \mathcal N} (z_{(j-1)k} + \hat{x}_{jk}) - \sum_{i \in P_j} b_{ijk} g_{ik} + z_{jk} \leq maxcap  
\end{equation}
...
\begin{equation}
    \frac{1}{2} ic\sum_{j \in \mathcal M} \sum_{k \in \mathcal N} (z_{(j-1)k} + z_{jk} + \hat x _{jk}) 
\end{equation}

Meanwhile the purchase cost can be given as: 

\begin{equation}
 \sum_{k \in \mathcal N}c_k x_k 
\end{equation}
...
\begin{equation}
 \sum_{k \in \mathcal N} \alpha_k mo_k x_k
\end{equation}
...
\begin{equation}
    \frac{1}{2} ic\sum_{j \in \mathcal M} \sum_{k \in \mathcal N} (z_{(j-1)k} + z_{jk} + \hat x _{jk}) + \sum_{k \in \mathcal N}c_k x_k - \sum_{k \in \mathcal N} \alpha _k mo_k x_k
\end{equation}
