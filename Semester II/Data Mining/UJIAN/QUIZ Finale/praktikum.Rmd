...
nomnoml::nomnoml("#direction: down
                 [<start>start] -> [random sentroid di domain x dan y|sentroid_1|sentroid_2]
                 [random sentroid di domain x dan y] -> [hitung jarak|semua titik ke sentroid]
                 ")
```
