...
Pada penelitian ini, _supplier selection_ akan disandingkan langsung dengan _raw material selection_ pada variabel-variabel mikro pada rentang waktu tertentu. Studi kasus yang digunakan berasal dari satu perusahaan manufaktur yang bergerak di bidang makanan dan minuman. Beberapa penelitian terkait dengan topik ini antara lain: 
...
Luaran dari penelitian ini adalah suatu model komputasi yang digunakan untuk menyelesaikan permasalahan optimisasi pemilihan _raw material_ dan _supplier selection_ dengan _input_ berupa:
